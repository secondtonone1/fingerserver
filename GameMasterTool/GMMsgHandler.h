#ifndef __LYNX_GAME_MASTER_MSG_HANDLER_H__ 
#define __LYNX_GAME_MASTER_MSG_HANDLER_H__
...
namespace Lynx
{
    ...
    public:
        ...
        {
            ASSERT(conn);
            LYNX_REGISTER_RECEIVED(conn, this, &GMMsgHandler::onReceived);
        }
...
#endif // __LYNX_GAME_MASTER_MSG_HANDLER_H__
