...
namespace Lynx 
{
    ...
    class _PlatformExport SpinMutex
    {
    public:
        SpinMutex();
        virtual ~SpinMutex();
    ...
    class _PlatformExport ReadWriteMutex
    {
    public:
        ReadWriteMutex();
	...
	class _PlatformExport LockTraits
    {
    public:
    ...
    class _PlatformExport SpinLockTraits
    {
    public:
    ...
    class _PlatformExport ReadLockTraits
    {
    public:
    ...
    class _PlatformExport WriteLockTraits
    {
    public:
        inline static void lock(ReadWriteMutex& mtx)
        {
