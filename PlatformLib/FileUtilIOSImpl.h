#ifndef __LYNX_PLATFORM_LIB_FILE_UTIL_IOS_IMPL_H__
#define __LYNX_PLATFORM_LIB_FILE_UTIL_IOS_IMPL_H__
...
#endif // __LYNX_PLATFORM_LIB_FILE_UTIL_IOS_IMPL_H__
