#ifndef __LYNX_PLATFORM_LIB_FILE_UTIL_H__
#define __LYNX_PLATFORM_LIB_FILE_UTIL_H__

#include "Compat.h"
#include "StreamBuffer.h"

#if defined(__ANDROID__) // 如果以后要从SD卡查找文件,则可能需要用到Linux的实现方案.
...
namespace Lynx
{
    class _PlatformExport FileUtil
    {
    public:
...
#endif // __LYNX_PLATFORM_LIB_FILE_UTIL_H__
